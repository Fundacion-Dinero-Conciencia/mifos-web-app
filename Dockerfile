...
ENV FINERACT_API_URLS=""
ENV FINERACT_API_URL=""
ENV FINERACT_PLATFORM_TENANT_IDENTIFIER=""
ENV MIFOS_DEFAULT_CHAR_DELIMITER=""
ENV MIFOS_DEFAULT_LANGUAGE=""
ENV MIFOS_DEFAULT_DATE_FORMAT=""
ENV MIFOS_OAUTH_SERVER_ENABLED=""
